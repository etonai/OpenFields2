...
**Created:**
- **src/main/java/combat/CharacterDebugUtils.java**: Debug utilities and auto-targeting debug controls (170 lines)
- **src/main/java/combat/CharacterLegacyAdapter.java**: Backward compatibility adapter for combined statistics (31 lines)  
- **src/main/java/combat/CombatStatisticsManager.java**: Combat statistics calculations and firing mode management (108 lines)
- **src/main/java/combat/HesitationManager.java**: Hesitation and bravery check system (236 lines)
