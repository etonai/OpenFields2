...
*Created: June 28, 2025 at 1:00 PM | Last Design Update: June 28, 2025 at 1:00 PM | Last Implementation Update: Not Started | Implementation Status: ⭕ PLANNING*
...
- [ ] **Core Shot Sequence Implementation**
  ...
  - [ ] Create shot pattern logic (Aimed → Quick → Quick → Aimed → Quick)
...
- **Shot Pattern**: 1st shot: character's aiming speed, 2nd-3rd: Quick, 4th: character's aiming speed, 5th: Quick
...
1. **Multiple Shot Control System**:
   ...
   - Pattern: Aimed → Quick → Quick → Aimed → Quick
