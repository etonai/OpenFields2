...
### 3. Combat Message Output Cleanup ⭕ **PLANNED**
...
- [ ] **Combat Output Analysis**
  - [ ] Identify all locations where combat messages are generated
  - [ ] Review current damage and incapacitation messaging
  - [ ] Find any inappropriate "headshot" or "kill" references in output
  - [ ] Document current message format patterns

- [ ] **Message Terminology Standardization**
  - [ ] Replace any "kill" references with "incapacitation" terminology
  - [ ] Remove any "headshot" emphasis from combat output
  - [ ] Ensure consistent damage reporting format
  - [ ] Standardize incapacitation messaging across all combat types

- [ ] **Combat Feedback Enhancement**
  - [ ] Review hit/miss messaging for clarity and consistency
  - [ ] Ensure damage values are clearly reported
  - [ ] Verify incapacitation events are properly announced
  - [ ] Test message output across different weapon types and combat scenarios
