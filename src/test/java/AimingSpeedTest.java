...
public class AimingSpeedTest {
    ...
    public void testAllConstructors_AimingSpeedInitialization() {
        ...
        combat.Character char1 = new combat.Character("Test1", 70, 100, 60, 50, 55, combat.Handedness.RIGHT_HANDED);
        ...
        combat.Character char3 = new combat.Character("Test3", 70, 100, 60, 50, 55, combat.Handedness.RIGHT_HANDED, skills);
        ...
        combat.Character char4 = new combat.Character("Test4", 70, 100, 60, 50, 55, combat.Handedness.RIGHT_HANDED, weapon, skills);
