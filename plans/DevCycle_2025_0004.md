...
*Created: June 12, 2025 at 11:00 PM PDT | Last Design Update: June 12, 2025 at 11:49 PM PDT | Implementation Status: PLANNING*

## 1. Unit Direction and Rotation ⭕ **PLANNING**
- [ ] **Character Rotation Animation System**
  - [ ] Implement rotation animation when character changes target direction
  - [ ] Add rotation speed calculation (360 degrees per second)
  - [ ] Track current facing direction vs target direction
  - [ ] Smooth interpolation between current and target rotation
  - [ ] Integration with weapon rendering direction updates

- [ ] **Rotation State Management**
  - [ ] Add current rotation field to Character or Unit class
  - [ ] Track rotation animation progress and timing
  - [ ] Handle rotation during movement and targeting changes
  - [ ] Ensure rotation completes before weapon positioning updates
  - [ ] Performance optimization for multiple rotating units
...
## 2. Weapon Rendering when Ready or Firing ⭕ **PLANNING**
- [ ] **Weapon State Visual Differentiation**
  - [ ] Implement different weapon positioning for ready/reloading states
  - [ ] Add weapon rotation calculations for non-aiming states
  - [ ] Create weapon state detection logic
  - [ ] Integrate with existing weapon rendering system
  - [ ] Test visual clarity between aiming and ready states

- [ ] **Weapon-Specific Ready State Positioning**
  - [ ] Pistol ready state: rotate 45 degrees towards unit center
  - [ ] Rifle ready state: move 2 feet closer to target + rotate 60 degrees towards center
  - [ ] Update weapon rendering calculations for each weapon type
  - [ ] Ensure weapon positioning works with handedness
  - [ ] Performance optimization for weapon state rendering
...
## 3. UI Info for Walk and Normal ⭕ **PLANNING**
- [ ] **Debug Mode Movement and Aiming Display**
  - [ ] Add debug mode toggle functionality
  - [ ] Implement movement speed display below unit circle
  - [ ] Implement aiming speed display below unit circle  
  - [ ] Create debug-only rendering conditions
  - [ ] Format display text for clarity and readability

- [ ] **Debug Mode Integration**
  - [ ] Add debug mode flag to game state
  - [ ] Integrate debug display with existing unit rendering
  - [ ] Ensure debug info doesn't interfere with normal gameplay
  - [ ] Add debug mode toggle key binding
  - [ ] Performance optimization for debug text rendering
...
## 4. Title Text ⭕ **PLANNING**
- [ ] **Game Startup Title Display**
  - [ ] Design and implement "OPEN FIELDS 2" title text display
  - [ ] Add ASCII art or enhanced formatting for title visibility
  - [ ] Display title text in console during game startup
  - [ ] Add appropriate spacing and visual embellishment
  - [ ] Ensure title displays before other startup messages

- [ ] **Theme Information Display**
  - [ ] Display current theme name during game startup
  - [ ] Format theme name display for clarity
  - [ ] Position theme display appropriately relative to title
  - [ ] Integrate with existing theme loading system
  - [ ] Add theme information to startup sequence
...
## 5. Submachine Gun ⭕ **PLANNING**
- [ ] **Submachine Gun Weapon Category**
  - [ ] Create SUBMACHINE_GUN weapon type enum value
  - [ ] Add submachine gun to WeaponType system
  - [ ] Update weapon factory to handle submachine gun creation
  - [ ] Modify weapon rendering to support submachine gun type
  - [ ] Add submachine gun skill integration

- [ ] **Submachine Gun Skill System**
  - [ ] Add submachine gun skill to SkillsManager
  - [ ] Create submachine gun skill default in Character.createDefaultSkills()
  - [ ] Integrate submachine gun skill with accuracy calculations
  - [ ] Add submachine gun skill to character stats display
  - [ ] Update very careful aiming to work with submachine gun skill

- [ ] **Submachine Gun Visual Rendering**
  - [ ] Implement 2.5 feet (17.5 pixels) length for submachine gun
  - [ ] Use firing/aiming rendering for ready and reloading states
  - [ ] Ensure proper positioning with handedness
  - [ ] Test visual distinction from rifle and pistol
  - [ ] Integrate with weapon state rendering system

- [ ] **Uzi Weapon Type Conversion**
  - [ ] Change Uzi weapon type from PISTOL to SUBMACHINE_GUN
  - [ ] Update Uzi weapon data in weapons.json files
  - [ ] Test Uzi with new submachine gun rendering
  - [ ] Verify Uzi works with submachine gun skill
  - [ ] Update any Uzi-specific references
...
## 6. Character Save and Starting Characters ⭕ **PLANNING**
- [ ] **Character Save Data Completeness**
  - [ ] Add missing combat experience fields to characters.json save format
  - [ ] Add faction field to character save data
  - [ ] Verify all Character class properties are saved
  - [ ] Update character serialization/deserialization
  - [ ] Test save/load compatibility with complete character data

- [ ] **New Character Addition**
  - [ ] Create new character with faction 2 in characters.json
  - [ ] Generate appropriate character stats and profile
  - [ ] Add unique character ID and naming
  - [ ] Ensure new character follows established character patterns
  - [ ] Add new character to universal character registry

- [ ] **Starting Character Configuration**
  - [ ] Give Alice (ID 1000) a submachine gun in CreateUnits
  - [ ] Add new faction 2 character to CreateUnits initialization
  - [ ] Update starting unit placement and configuration
  - [ ] Test starting character setup with new weapons and characters
  - [ ] Verify faction assignment and character initialization
